...
namespace AI_Chat.Plugins
{
    ...
    public interface IPluginManager
    {
        ...
        /// 获取所有插件信息（包括禁用的插件）
        /// </summary>
        IEnumerable<PluginInfo> GetAllPluginInfos();
        ...
        /// 获取所有可用插件的能力列表
        /// </summary>
        Dictionary<string, List<PluginCapability>> GetAllPluginCapabilities();

        /// <summary>
        /// 调用指定插件的能力
        /// </summary>
        PluginCapabilityResult InvokePluginCapability(string pluginId, string capabilityName, Dictionary<string, object> parameters);

        /// <summary>
        /// 生成可用插件能力提示词（用于大模型）
        /// </summary>
        string GeneratePluginCapabilitiesPrompt();
    }
}
